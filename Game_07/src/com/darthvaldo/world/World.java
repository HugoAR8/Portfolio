...
public class World {
	...
	public static int CICLO = noite;
	
	
	
	public World() {	
	/*	
		String[] tilesTypes = {"grama","areia","neve","",};
		HEIGHT = 80 ;
		WIDTH = 1000;
		//divisor do mapa
		...
		for(int xx = 0; xx < WIDTH; xx++) {
			int initialHeight = Entity.rand.nextInt(12-10)+10;
					...
					if(yy >= initialHeight) {
						...
						if(tilesTypes[indexBioma] == "grama") {
							...
							if(yy - 1 < initialHeight) {
								...
								tiles[xx+yy*WIDTH] = new WallTile(xx*16,yy*16,Tile.TILE_SAND_2);
							}
